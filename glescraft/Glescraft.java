...
//
//	static int now;//time_t
//	static int keys;
//	static boolean select_using_depthbuffer = false;
//
...
//
//	// Sea level
//	static int SEALEVEL  = 4;
//
//	// Number of VBO slots for chunks
//	static int CHUNKSLOTS = (SCX * SCY * SCZ);
//
//	static int[] transparent= new int[]{2, 0, 0, 0, 1, 0, 0, 0, 3, 4, 0, 0, 0, 0, 0, 0}; 
//	static String[] blocknames = new String[]{
...
//		short x, y, z, w;
//		byte4() {}
//		byte4(short x, short y, short z, short w){
//			this.x = x;
//			this.x = y;
//			this.x = z;
//		}
