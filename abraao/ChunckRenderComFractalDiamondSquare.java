...
public class ChunckRenderComFractalDiamondSquare implements Render {
	...
	public ChunckRenderComFractalDiamondSquare(ShaderProgram shaderProg) {
...
//		  Plane plane = new Plane(perlin);
//		  
//		  for(int x = 0; x < CX; x++) {
//		    for(int z = 0; z < CZ; z++) {
//		    	
//		    	double height = Math.abs(plane.getValue(x+0.1, z+0.1)*72);
//		    	
