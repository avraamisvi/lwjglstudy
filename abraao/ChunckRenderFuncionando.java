...
public class ChunckRenderFuncionando implements Render {
	...
	public ChunckRenderFuncionando(ShaderProgram shaderProg) {
...
//		textCoords = vertices;
	...
	public void criarVertices() {
		  ...
		  OpenSimplexNoise openNoise = new OpenSimplexNoise();
...
//		    	 System.out.println("noise:" + noise.noise(x, y, z));
		  ...
		  System.out.println("TOTAL vertices:" + verts.size());
		  System.out.println("TOTAL cubos:"    + verts.size()/36);
		  
		  this.vertices = new float[verts.size()*3];
		  int counter = 0;
		  
		  textCoords = new float[(verts.size()/36)*72];
